...
<style>
    ...
    .skill-card { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 1.5rem; border-radius: 10px; color: white; text-align: center; margin: 0.5rem 0; }
    .contact-card { background: linear-gradient(135deg, #d299c2 0%, #fef9d7 100%); padding: 1rem; border-radius: 8px; margin: 0.5rem 0; text-align: center; }
    .project-card { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 1.5rem; border-radius: 10px; color: white; margin: 1rem 0; }
    .timeline-item { background: white; padding: 1rem; border-left: 4px solid #3498db; margin: 0.5rem 0; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
</style>
""",
...
def main():
    ...
    with col2:
        ...
        gallery = ["assets/home1.jpg", "assets/home2.jpg", "assets/home3.jpg"]

        # Slider untuk navigasi
        index = st.slider("Geser untuk lihat gambar", 1, len(gallery), 1)
        st.image(gallery[index-1], use_column_width=True, caption=f"Gambar {index}")
